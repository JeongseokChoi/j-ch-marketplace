...
└── ## my-api · 2026-09-21 19:30          세션
    ...
    │       note: 🤖 Find JWT verify callers 의 보고에 답함 + 답변 전문    보고에 답한 턴
...
항목이 아니라 **메인 세션의 턴**으로 남는다. 진행 중에는 노트에 `🤖 ○○ 의 보고에 답하는 중` 이라
적히고, 끝나면 제목은 답변 첫 문장, 노트는 답변 전문이 된다. 작업 도중에 끼어든 보고는 그 턴
